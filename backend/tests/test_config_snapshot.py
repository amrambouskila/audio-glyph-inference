...
def test_config_snapshot_flattens_settings_values() -> None:
    settings = BackendSettings(
        font_file=Path("/tmp/font.ttf"),  # noqa: S108 -- literal path fixture; never opened
    ...
    assert snapshot["font_file"] == str(Path("/tmp/font.ttf"))  # noqa: S108 -- literal path fixture; never opened
