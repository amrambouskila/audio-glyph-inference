...
8. **Binary over text for the live loop.** Audio frames and geometry updates go over WebSocket as MessagePack-framed binary. JSON only for metadata. See project AGENTS.md §4 for the wire protocol.
