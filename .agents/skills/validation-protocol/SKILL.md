...
1. **No mocking of core math, no mocking of the database.** Numerical code is tested against real computations. Integration tests use a real Postgres via a test container. These are hard rules — see global AGENTS.md §7 and project AGENTS.md §7.
