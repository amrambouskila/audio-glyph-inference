...
description: Proactively applied at session start and before any implementation work; orients Claude to the current phase and its explicit scope constraints
---
